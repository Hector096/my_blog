...
RSpec.describe Post, type: :model do
  describe 'post validation tests' do
    subject do
      vishal = User.new(name: 'Vishal Verma', photo: 'img1', bio: 'Het there all good!', posts_counter: 0)
      vishal.posts.new(title: 'good title', text: 'Welcome to world of vishal', comments_counter: 2, likes_counter: 2)
    end
