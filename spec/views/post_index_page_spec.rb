...
RSpec.describe 'Login', type: :feature do
  describe 'User' do
    before(:each) do
      ...
      @comment2 = @post1.comments.create!(text: 'This is the second comment', author_id: @user1.id)
      @comment3 = @post1.comments.create!(text: 'This is the third comment', author_id: @user1.id)
